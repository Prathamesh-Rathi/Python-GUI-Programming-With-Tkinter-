...
#cursorObj.execute("INSERT INTO coin VALUES(1,'BTC',2,120)")
#con.commit()

#cursorObj.execute("INSERT INTO coin VALUES(2,'ETH',5,30)")
#con.commit()

#cursorObj.execute("INSERT INTO coin VALUES(3,'USDT',15,60)")
#con.commit()
def reset():
...
def my_crypto():
    api_request= requests.get("https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=20&convert=USD&CMC_PRO_API_KEY=bd810d3c-5963-41a4-8128-a8d31df7bda1")
    ...
    for i in range(0, 20):
        for coin in coins:
            if api["data"][i]["symbol"] == coin[1]:
                ...
                portfolio_id = Label(pycrypto, text=coin[0], bg="black", fg="orange", font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
                ...
                price=Label(pycrypto,text="${0:.2f}".format(api["data"][i]["quote"]["USD"]["price"]),bg="white",fg="black",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
                price.grid(row=coin_row,column=2,sticky=N+S+E+W)

                no_coin=Label(pycrypto,text=coin[2],bg="white",fg="black",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
                ...
                pl_coin=Label(pycrypto,text="${0:.2f}".format(pl_percoin),bg="white",fg=font_color(float("{0:.2f}".format(pl_percoin))),font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
                ...
                total_plwithcoin=Label(pycrypto,text="${0:.2f}".format(total_pl),bg="white",fg=font_color(float("{0:.2f}".format(total_pl))),font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
                total_plwithcoin.grid(row=coin_row,column=7,sticky=N+S+E+W)


                total_currentvalue=Label(pycrypto,text="${0:.2f}".format(total_current_value),bg="white",fg=font_color(float("{0:.2f}".format(total_current_value))),font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
                total_currentvalue.grid(row=coin_row,column=5,sticky=N+S+E+W)

                total_amountpaid=Label(pycrypto,text="${0:.2f}".format(total_amount_paid),bg="white",fg=font_color(float("{0:.2f}".format(total_amount_paid))),font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
                total_amountpaid.grid(row=coin_row,column=4,sticky=N+S+E+W)
    ...
    add_coin = Button(pycrypto, text="Add Coin", bg="#030E4F", fg="yellow", command=insert_coin ,font="Lato 12", borderwidth=2, relief="groove", padx="2", pady="2")
    ...
    update_coin_txt = Button(pycrypto, text="Update Coin", bg="#030E4F", fg="yellow", command=update_coin ,font="Lato 12", borderwidth=2, relief="groove", padx="2", pady="2")
    ...
    delete_coin_txt = Button(pycrypto, text="Delete Coin", bg="#030E4F", fg="yellow", command=delete_coin ,font="Lato 12", borderwidth=2, relief="groove", padx="2", pady="2")
...
def app_header():
    ...
    name=Label(pycrypto,text="Coin Name",bg="#ffd343",fg="red",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
    name.grid(row=0,column=1,sticky=N+S+E+W)

    price=Label(pycrypto,text="Price",bg="#ffd343",fg="red",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
    price.grid(row=0,column=2,sticky=N+S+E+W)

    no_coin=Label(pycrypto,text="No of coins",bg="#ffd343",fg="red",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
    no_coin.grid(row=0,column=3,sticky=N+S+E+W)

    amount_paid=Label(pycrypto,text="Amount Paid",bg="#ffd343",fg="red",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
    amount_paid.grid(row=0,column=4,sticky=N+S+E+W)

    current_val=Label(pycrypto,text="Current value",bg="#ffd343",fg="red",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
    current_val.grid(row=0,column=5,sticky=N+S+E+W)

    pl_coin=Label(pycrypto,text="P/L Per Coin",bg="#ffd343",fg="red",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
    pl_coin.grid(row=0,column=6,sticky=N+S+E+W)

    totalpl=Label(pycrypto,text="Total P/L with Coin",bg="#ffd343",fg="red",font="lato 12 bold",padx="5",pady="5",borderwidth=2,relief="groove")
